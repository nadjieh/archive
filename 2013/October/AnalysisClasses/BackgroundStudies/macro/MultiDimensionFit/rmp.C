...
//X: F0
//Y: FL
	double corr = -0.911083;
	double centFL = 0.283083;
	double centF0 = 0.648717;
	double sigL = sqrt(pow(0.0462802,2));
	double sig0 = sqrt(pow(0.07931,2));
	cout<<sigL<<"\t"<<sig0<<endl;
