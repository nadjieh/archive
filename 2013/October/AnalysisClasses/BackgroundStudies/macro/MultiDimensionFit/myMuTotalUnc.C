...
//X: F0
//Y: FL
	double corr = -0.924942;
//    double corr = 0;
	double centFL = 0.308293;
	double centF0 = 0.722384;
	double sigL = sqrt(pow(0.040,2)+pow(0.0330207,2));
	double sig0 = sqrt(pow(0.037,2)+pow(0.0508888,2));
	cout<<sigL<<"\t"<<sig0<<endl;
