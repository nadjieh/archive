...
int main(int argc, char** argv) {
    ...
    for (int f = 1; f < argc; f++) {
        ...
        if (arg_fth == "signal7") {
            ...
            input7tmp.Wtemplate = ((TH1*) file->Get("Default_Def/Default_DefcosTheta"));
            ...
            file = new TFile(out.c_str(), "read");
            input8tmp.Wtemplate = ((TH1*) file->Get("Default_Def/Default_DefcosTheta"));
...
//    double x[8] = {0.697186, 0.349027, -0.0419, -0.0565, 1., 1., 1., 1.};
    double x[8] = {0.697186, 0.349027, 0, 0, 1., 1., 1., 1.};
    ...
    if (is2Drecgen && !singleMatrix && do3D) {
        ...
        GetMinimumLuca(myLL.first, x, xerr, correlation, true);
        delete myLL.second;
    } else {
