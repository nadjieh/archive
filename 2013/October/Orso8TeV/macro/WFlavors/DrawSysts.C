...
TFile *Up = TFile::Open("2J0T/emtw/"+chan+"_"+name+"UpWTemplate100_plots.root");
TFile *Down = TFile::Open("2J0T/emtw/"+chan+"_"+name+"DownWTemplate100_plots.root");
cout<<"1"<<endl;
TH1D * Temp = (TH1D*)Data->Get("Default_Def/Default_DefcosTheta");
...
c->SaveAs(chan+"_"+name+"Systs_emtw100.C");
}
