...
//// METUp
F0Up.push_back(0.00278747);	FlUp.push_back(-0.00198019);	FrUp.push_back(-0.000807284);
//// puUp
...
//// gR
F0Up.push_back(0.722 * (0.9882-1));	FlUp.push_back(0.075 * 0.308);	FrUp.push_back((0.9802-1)*(-0.030));
...
//// METDown
F0Down.push_back(-0.00390809);	FlDown.push_back(0.00488204);	FrDown.push_back(-0.000973956);
//// puDown
...
//// gR
F0Down.push_back(0.722 * (0.9882-1));	FlDown.push_back(0.075 * 0.308);	FrDown.push_back((0.9802-1)*(-0.030));
