...
/*   double EStat = 0.072;
   ...
   // for emtw
   double combStatMt = 0.020;
   double combSystMt = 0.023;
   double combCentMt = -0.049;
   pave = new TPave(combCentMt-combSystMt,0.7,combCentMt+combSystMt,0.72,0,"br");
   pave->SetFillColor(5);
   pave->Draw();

   double EStatMt = 0.036;
   double ESystMt = 0.057;
   double ECentMt = -0.091;
   pave = new TPave(ECentMt-ESystMt,0.9,ECentMt+ESystMt,0.92,0,"br");
   pave->SetFillColor(5);
   pave->Draw();
  ...
  /* double D0Syst = 0.034;
   ...
   gre = new TGraphErrors(1);
   gre->SetName("Graph");
   gre->SetTitle("combination_mtw");
   gre->SetFillColor(1);
   gre->SetMarkerStyle(20);
   gre->SetPoint(0,combCentMt,0.71);
   gre->SetPointError(0,combStatMt,0);
   gre->Draw("p");
   ...
   gre->SetFillColor(1);
   gre->SetMarkerStyle(20);
   gre->SetPoint(0,ECentMt,0.91);
   gre->SetPointError(0,EStatMt,0);
   gre->Draw("p");
   ...
   tex = new TLatex(0.09,0.9010391,"CMS preliminary (e+jets,");
   tex->SetTextSize(0.02140673);
   tex->SetTextColor(kRed);
   tex->SetLineWidth(2);
   tex->Draw();

   tex = new TLatex(0.085,0.83976743," m_{T}^{W} instead of MET)");
   ...
   tex = new TLatex(0.09,0.6981692,"CMS preliminary (combination,");
   tex->SetTextSize(0.02140673);
   tex->SetLineWidth(2);
   tex->SetTextColor(kRed);
   tex->Draw();

   tex = new TLatex(0.085,0.62976743," m_{T}^{W} instead of MET)");
   ci = TColor::GetColor("#006600");
   tex->SetTextColor(kRed);
   tex->SetTextSize(0.0212766);
   tex->SetLineWidth(2);
