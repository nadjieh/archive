...
./Syst2J1T dirName TreesEle input TbarChannel_MassUp METResolFileName /home/nadjieh/work/AnalysisClasses/ToyAnalysis/macro/METresolutions.root isData no  stack yes  > TreesEle_TbarChannel.txt
