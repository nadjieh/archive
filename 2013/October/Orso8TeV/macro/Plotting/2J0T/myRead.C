...
//	double scale = 1.09331;
	double scale1 = 282994./266972.;
	double scale2 = 282994./262255.;
//	myRead("Default_allWcosTheta","Ele_cosTheta_2j0tag.C",scale);
//	myRead("Default_allWcosTheta","Mu_cosTheta_2j0tag.C",scale);
	myRead("DefaultTrue_allWcosTheta","ele_cosTheta_true.C",scale1);
	myRead("DefaultTrue_allWcosTheta","mu_cosTheta_true.C",1);
	double scale3 = 519181./515423.;
	myRead("DefaultTrue_allWcosTheta","eleDPhi_cosTheta_true.C",scale2);
	myRead("DefaultTrue_allWcosTheta","muDPhi_cosTheta_true.C",1);
	double scale4 = 519181./515428.;
