...
TFile * f =  new TFile("2J1T/TreesMu_bUpWJetsMC_RW.root","recreate");
f->mkdir("Default_allW")->cd();
bUp->Write("Default_allWcosTheta");
f->Save();
f->Close();
TFile * f1 =  new TFile("2J1T/TreesMu_bDownWJetsMC_RW.root","recreate");
...
/*{
TFile *_file0 = TFile::Open("2J1T/emtw/TreesEle_bXWJets_plots.root");
TFile *_file1 = TFile::Open("2J1T/emtw/TreesEle_cWJets_plots.root");
TFile *_file2 = TFile::Open("2J1T/emtw/TreesEle_lWJets_plots.root");
TFile *_file3 = TFile::Open("2J1T/emtw/TreesEle_WJets_plots.root");
TH1D * b = (TH1D*)_file0->Get("Default_allW/Default_allWcosTheta");
TH1D * c = (TH1D*)_file1->Get("Default_allW/Default_allWcosTheta");
TH1D * l = (TH1D*)_file2->Get("Default_allW/Default_allWcosTheta");
TH1D * bUp = (TH1D*)b->Clone("bUp");
...
bUp->Scale(nwjets/bUp->Integral());
bDown->Scale(nwjets/bDown->Integral());
TFile * f =  new TFile("2J1T/emtw/TreesEle_bUpWJetsMC_RW.root","recreate");
f->mkdir("Default_allW")->cd();
bUp->Write("Default_allWcosTheta");
f->Save();
f->Close();
TFile * f1 =  new TFile("2J1T/emtw/TreesEle_bDownWJetsMC_RW.root","recreate");
f1->mkdir("Default_allW")->cd();
bDown->Write("Default_allWcosTheta");
f1->Save();
f1->Close();
...
TFile * f =  new TFile("2J1T/TreesMu_cUpWJetsMC_RW.root","recreate");
f->mkdir("Default_allW")->cd();
cUp->Write("Default_allWcosTheta");
f->Save();
f->Close();
TFile * f1 =  new TFile("2J1T/TreesMu_cDownWJetsMC_RW.root","recreate");
f1->mkdir("Default_allW")->cd();
...
cUp->Scale(nwjets/cUp->Integral());
cDown->Scale(nwjets/cDown->Integral());
TFile * f =  new TFile("2J1T/emtw/TreesEle_cUpWJetsMC_RW.root","recreate");
f->mkdir("Default_allW")->cd();
cUp->Write("Default_allWcosTheta");
f->Save();
f->Close();
TFile * f1 =  new TFile("2J1T/emtw/TreesEle_cDownWJetsMC_RW.root","recreate");
f1->mkdir("Default_allW")->cd();
cDown->Write("Default_allWcosTheta");
f1->Save();
f1->Close();
