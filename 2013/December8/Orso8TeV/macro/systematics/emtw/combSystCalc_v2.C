...
//// VR
F0Up.push_back(0);	FlUp.push_back(0.065*0.298);	FrUp.push_back((0.9796-1)*-0.049);
//// gL
F0Up.push_back((0.9326-1)*0.750);	FlUp.push_back(0.112*0.298);	FrUp.push_back((0.9763-1)*-0.049);
...
//// VR
F0Down.push_back(0);	FlDown.push_back(0.065*0.298);	FrDown.push_back((0.9796-1)*-0.049);
//// gL
F0Down.push_back((0.9326-1)*0.750);	FlDown.push_back(0.112*0.298);	FrDown.push_back((0.9763-1)*-0.049);
