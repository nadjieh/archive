...
//=========  (Tue Oct  1 14:56:07 2013) by ROOT version5.32/00
   ...
   TEllipse *ellipse = new TEllipse(0.107619,-0.0632456,0.09269195,0.01895783,0,360,-34.02398);
   ...
   gre->SetPoint(0,0.1058366,-0.06237407);
   ...
   ellipse = new TEllipse(0.1058366,-0.06237407,0.1338521,0.05194549,0,360,-30.02208);
   ...
   ellipse = new TEllipse(0.107619,-0.0632456,0.1622842,0.05682444,0,360,-31.44379);
   ellipse->SetFillStyle(0);
