...
F0Up.push_back(-0.0089564);	FlUp.push_back(-0.00372369);	FrUp.push_back(0.0126801);
//// bUp
...
////MC stat
F0Up.push_back(-0.006591);	FlUp.push_back(0.001445);	FrUp.push_back(0.005145);
////VR
//F0Up.push_back(0);	FlUp.push_back(0.066*0.285783);	FrUp.push_back((0.8978-1)*(-0.0905856));
F0Up.push_back(0);	FlUp.push_back(0.064*0.285783);	FrUp.push_back((0.9516-1)*(-0.0905856));
////gL
//F0Up.push_back((0.8307-1)*0.804803);	FlUp.push_back(0.184*0.285783);	FrUp.push_back((0.924-1)*(-0.0905856));
//F0Up.push_back(0);	FlUp.push_back(0);	FrUp.push_back(0);
...
////MC stat
F0Down.push_back(-0.006591);	FlDown.push_back(0.001445);	FrDown.push_back(0.005145);
////VR
//F0Down.push_back(0);	FlDown.push_back(0.066*0.285783);	FrDown.push_back((0.8978-1)*(-0.0905856));
F0Down.push_back(0);	FlDown.push_back(0.064*0.285783);	FrDown.push_back((0.9516-1)*(-0.0905856));
////gL
//F0Down.push_back((0.8307-1)*0.804803);	FlDown.push_back(0.184*0.285783);	FrDown.push_back((0.924-1)*(-0.0905856));
//F0Down.push_back(0);	FlDown.push_back(0);	FrDown.push_back(0);
