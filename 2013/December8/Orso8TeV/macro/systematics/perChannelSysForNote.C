...
//// VR
F0Up.push_back(0);	FlUp.push_back( 0.03*0.283);	FrUp.push_back( 0.068 * (0.9656-1));
//// gR
F0Up.push_back((0.9422-1)*0.649);	FlUp.push_back( 0.067*0.283);	FrUp.push_back( 0.068*(0.9715-1));
...
//// VR
F0Down.push_back(0);	FlDown.push_back( 0.03*0.283);	FrDown.push_back( 0.068 * (0.9656-1));
//// gR
F0Down.push_back((0.9422-1)*0.649);	FlDown.push_back( 0.067*0.283);	FrDown.push_back( 0.068*(0.9715-1));
...
//// VR
F0UpM.push_back(0);	FlUpM.push_back(0.061 * 0.308);	FrUpM.push_back((0.996-1)*(-0.030));
//// gR
F0UpM.push_back(0.722 * (0.9514-1));	FlUpM.push_back(0.098 * 0.308);	FrUpM.push_back((0.9705-1)*(-0.030));
...
//// VR
F0DownM.push_back(0);	FlDownM.push_back(0.061 * 0.308);	FrDownM.push_back((0.996-1)*(-0.030));
//// gR
F0DownM.push_back(0.722 * (0.9514-1));	FlDownM.push_back(0.098 * 0.308);	FrDownM.push_back((0.9705-1)*(-0.030));
